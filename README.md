...
```bash
FERROMA_VERSION=0.1.7                      # docker-compose.prod.yml: the tag to pull
# FERROMA_IMAGE=wesukilaye/ferroma:0.1.7   # docker-compose.external-db.yml: the whole reference
```

Available tags are `0.1.7` (an exact release) and `latest` (the newest release) — a
