...
FERROMA_VERSION=0.1.13 docker compose -f docker-compose.yml up -d
```
...
| Tag | Meaning |
|---|---|
| `0.1.13` | an exact release — pin this in production |
