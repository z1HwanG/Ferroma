...
FERROMA_VERSION=0.1.16 docker compose -f docker-compose.yml up -d
```
...
| Tag | Meaning |
|---|---|
| `0.1.16` | an exact release — pin this in production |
