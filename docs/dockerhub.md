...
FERROMA_VERSION=0.1.17 docker compose -f docker-compose.yml up -d
```
...
| Tag | Meaning |
|---|---|
| `0.1.17` | an exact release — pin this in production |
