...
FERROMA_VERSION=0.1.6 docker compose -f docker-compose.prod.yml up -d
```
...
| Tag | Meaning |
|---|---|
| `0.1.6` | an exact release — pin this in production |
